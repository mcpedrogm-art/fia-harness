# TASK-F2 — PARSER ENGINE CON NIVELES DE CONFIANZA
...
**Objetivo (desde PROGRESS.md):** Parser Engine con niveles de confianza / extractfield(...) -> ExtractionResult, config de sinónimos, corpus de PRDs, métrica %
**Dependencias:** F1

# TASK-F1 — EXTRACCIÓN DEL CORE + SUPERFICIE FIA
...
**Objetivo (desde PROGRESS.md):** Extracción del Core + superficie fia / Módulos core/parser/generators, fachadas generadas, entry point fia
**Dependencias:** F0

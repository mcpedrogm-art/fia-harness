...
- **F14** (2026-09-21) · Reapertura · Razón: v3.6.2: ajustes del test como usuario externo (nota de cache uv, aclaracion del PRD.md y sinonimos del parser para briefs reales)
## Aprobaciones

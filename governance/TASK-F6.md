...
**Objetivo (desde PROGRESS.md):** Verification Engine / fia verify (STATE/DEPS/EVIDENCE/PROVENANCE/SEALS/SPEC) + smoke de tampering
**Dependencias:** F5

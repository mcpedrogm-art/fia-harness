# TASK-F4 — SPIKE: MECANISMO DE CAPTURA DE EVIDENCIA
...
**Objetivo (desde PROGRESS.md):** Spike: mecanismo de captura de evidencia / docs/EVIDENCECAPTUREDECISION.md + ejemplo end-to-end
**Dependencias:** F3

# TASK-F0 — BASELINE V2.2 Y DOGFOOD DEL REPO
...
**Objetivo (desde PROGRESS.md):** Baseline v2.2 y dogfood del repo / docs/V3BASELINE.md, suite 75/75 registrada, rama v3.0-core, CI con --check
**Dependencias:** —
...
#### Checklist de Visibilidad Activo (extraído en vivo de `AEO_GEO_SEO.md`):
